...
<nav id="navbar">
  <div class="nav-inner">
    <a href="index.html" class="logo">
      <img src="logo1_nobg.png" alt="Harmony Spaces by G" class="logo-img"
  ...
  <div class="container">
    <div class="footer-top">
      <div class="footer-brand">
        <a href="index.html" class="logo">
          <img src="logo1_nobg.png" alt="Harmony Spaces by G" class="logo-img footer-logo-img"
               onerror="this.style.display='none';this.nextElementSibling.style.display='flex'" />
          <span class="logo-fallback" style="display:none">
            <span class="logo-mark">H</span>
            <div class="logo-text">
        ...
        <div class="social-links">
          ...
          <a href="mailto:ceo@harmonyspacebyg.com" aria-label="Email">
      ...
      <div class="footer-contact">
        ...
        <p><a href="mailto:ceo@harmonyspacebyg.com">ceo@harmonyspacebyg.com</a></p>
